...
export default function CallToAction() {
  ...
  return (
    <section className="bg-background text-foreground py-24 px-4 sm:px-6 lg:px-8 w-full overflow-hidden relative">
      ...
      <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-6 text-left space-y-6 max-w-2xl">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs font-semibold uppercase tracking-wider bg-muted text-primary border border-border/60">
            <Droplet className="w-3.5 h-3.5 fill-current animate-pulse" />
            SaaS Lifecycle Core
          </span>

          <h2 className="text-4xl sm:text-5xl font-black tracking-tight text-foreground leading-[1.1] font-heading">
            Optimize critical donor matching lines with smart network analytics
          </h2>

          <p className="text-base sm:text-lg text-gray-400 font-normal leading-relaxed font-body">
          ...
          <div className="absolute top-6 left-4 bg-secondary border border-border/80 p-4 rounded-xl shadow-lg max-w-[210px] space-y-2 transform hover:-translate-y-1 transition-transform">
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-[11px]">
                <span className="text-gray-400">O+ Reserve</span>
                <span className="font-bold text-emerald-500">Optimal</span>
              </div>
              <div className="flex justify-between text-[11px]">
                <span className="text-gray-400">A- Reserve</span>
          ...
          <div className="absolute bottom-6 right-8 bg-secondary border border-border/80 p-4 rounded-xl shadow-lg min-w-[210px] space-y-2 transform hover:-translate-y-1 transition-transform">
            ...
            <div className="space-y-1.5 text-[11px]">
              <div className="flex items-center justify-between">
                <span className="text-gray-400">Sector-A Banks</span>
                <span className="font-bold text-foreground">
                  14 Units dispatched
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-400">Sector-G Clinics</span>
                <span className="font-bold text-foreground">
                  8 Units dispatched
                </span>
              </div>
